#' Generate Result of fisher.test for only one column on highcharter
#' 
#' this function will be deprecated in next version
#' @param pathway_list a list that has pathways as name,metabolites in 
#' sublist
#' @param pathway the string that stand for a pathway
#' @param num_of_meta an int that describe how many analytes in this pathway
#' @return a dataframe that demonstrates stats result, p value and method
#' @export
...
#' Search pathways from list of analytes in fast algorithm
#' 
#' @param synonym a string or data.frame that contains given analytes
